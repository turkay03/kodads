        ...
        fsm = {
          ...
          'ads-ready?': {
            ...
            events: {
			  ...
			  ,'adserror': function() { 
				//reklam boş geldiğinde timeout beklemeden videoyu oynat (reklam modeli adrule olduğunda bu şekilde bir problem olmuyordu çünkü preroll rimeout değeri farklıydı. 
				//Fakat adrule dışında timeout 10 saniye oluyor)
				//console.log("xxxx---");
				 this.state = 'ad-timeout-playback';
              }
            }
