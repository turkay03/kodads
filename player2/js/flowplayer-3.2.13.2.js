   ...
   function init() {
		...
		function installPlayer() {
			...
			if (html.replace(/\s/g, '') !== '') {
				...
				//bu bölüm div konulması durumunda player'ın click sonrası yüklenmesini sağlıyordu. Tüm sitelerde direkt yüklenme olduğu için commentlendi.
...
!function() {
	...
	function Flash(root, opts, conf) {
		...
		// express install
			...
			console.log("fail #2.1 custom content inside container");
